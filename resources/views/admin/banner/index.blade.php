        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Banner Menu</span>

                    <span class="text-muted mt-1 fw-semibold fs-7">Over 500 product</span>
                </h3>
                <div class="">
                    <a href="/admin/banner/add" class="btn btn-sm btn-light btn-active-primary">
                        <i class="ki-duotone ki-plus fs-2"></i> New Banner
                    </a>
                </div>
            </div>
            <!--end::Header-->
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bold text-muted">
                                ...
                                <th class="min-w-100px">Trạng thái / Vị trí</th>
                                <th class="min-w-100px">Thay đổi</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
                        ...
                        <tbody>
                            @if ($banners->count() > 0)
                                @foreach ($banners as $banner)
                                    <tr>
                                        <td> <a href="#">
                                                <img class="img-fluid" src="{{ $banner->path }}" alt=""
                                        ...
                                        <td>
                                            <span class="text-gray-900 fw-bold text-hover-primary d-block fs-6">
                                                @if ($banner->status == 1)
                                                    ...
                                                    @else{{ 'Deactive / ' }}
                                                @endif
                                                @if ($banner->status == config('app.vitri.TRANGHOME'))
                                                    {{ 'Trang Home' }}
                                                    @else{{ 'Trang Shop' }}
                                                @endif
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex flex-shrink-0">
                                                ...
                                                <form action="{{ route('admin.page.supllier.delete', $banner->id) }}"
                            ...
                            @else
                                <tr>
                                    <td class="text-center" colspan="5">NOT FOUND BANNER</td>
                                </tr>
                            @endif
                        </tbody>
                        <!--end::Table body-->
